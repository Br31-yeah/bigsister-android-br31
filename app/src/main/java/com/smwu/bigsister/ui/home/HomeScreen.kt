...
import com.smwu.bigsister.ui.components.EmptyRoutineState
import com.smwu.bigsister.ui.components.HomeTopBar
import com.smwu.bigsister.ui.components.ReservationCard
import com.smwu.bigsister.ui.components.WeeklyCalendar
...
fun HomeScreen(
    ...
    // 🔍 로그를 추가해서 날짜가 계속 바뀌는지 확인해보세요.
    LaunchedEffect(selectedDate) {
        println("DEBUG: Current selectedDate is $selectedDate")
    }
